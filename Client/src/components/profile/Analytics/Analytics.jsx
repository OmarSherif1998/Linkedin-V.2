...
function Analytics() {
	return (
		<div className='flex flex-col gap-[1rem]  bg-white rounded-xl border border-gray-400 shadow-lg '>
			...
			<button className='flex items-center justify-center w-full gap-1 py-2 font-medium text-gray-900 hover:bg-gray-100 '>
				{' '}
