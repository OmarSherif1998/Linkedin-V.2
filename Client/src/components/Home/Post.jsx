...
const Post = forwardRef(
	({ name, bio, postTextBody, photoURL, postPictureUrl, data }, ref) => {
		return (
			<div
				ref={ref}
			...
			>
				...
				<div className='flex mb-[0.625rem]  '>
					...
					<div className='ml-[0.625rem]'>
						<h2 className='text-[0.9375rem] text-black font-normal'>
							{data.username}
						</h2>
						<p className='text-[0.75rem] text-gray-500'>{data.bio}</p>
					</div>
				...
				<div className='break-words'>
					<p className='ml-[2rem] '>{data._doc.content}</p>
				</div>
