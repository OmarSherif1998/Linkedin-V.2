...
function Header() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`border-light-gray sticky top-0 z-[999] ${pathName.startsWith("/Settings") ? "mb-0" : "mb-6PLo"} flex h-[4rem] w-full items-center ${borderClass} border-b ${componentBGColorClass} px-4 sm:px-6 md:px-8`}
      >
